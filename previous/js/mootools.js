...
}});function a(b){return(/^(?:body|html)$/i).test(b.tagName);}}).call(this);var SmoothScroll=Fx.SmoothScroll=new Class({Extends:Fx.Scroll,options:{axes:["x","y"]},initialize:function(c,d){d=d||document;
